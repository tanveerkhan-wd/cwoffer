...
<script type="text/javascript" src="{{ url('js/firebase-admin.js') }}"></script> --}}
{{-- <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/jquery-datetimepicker/2.5.20/jquery.datetimepicker.full.min.js"></script> --}}
{{-- <script type="text/javascript" src="{{ url('js/dashboard/notifications.js') }}"></script> --}}
<script type="text/javascript">
  ...
  var base_url = '{{ url('/') }}';
  var global_user_type = '{{ Auth::User()->user_type==1 ? 'seller' : 'admin'}}';
  $('.select2').select2();
