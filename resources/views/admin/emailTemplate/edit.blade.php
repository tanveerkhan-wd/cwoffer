...
@section('title','Email Sms Template')
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12 mb-3">
                           <h2 class="title"><a data-slug="admin/emailSmsTemplates" href="{{url('/admin/emailSmsTemplates')}}"><span>{{'Email Sms Template'}}</span></a> > {{' Edit '}}</h2>
                        </div> 
                        <div class="col-12">
                            <div class="white_box pt-5 pb-5">
                                <div class="container-fliid">
                                    <div class="row">
                                        <div class="col-12">
                                            <form name="edit-form">
                                                <input type="hidden" name="cid" value="{{$data->email_sms_master_id}}">
                                                <div class="box-body">
                                                    <div class="row">
                                                    ...
                                                    <div class="text-center">
                                                        ...
                                                        <a class="theme_btn red_btn ajax_request" data-slug="admin/emailSmsTemplates" href="{{url('admin/emailSmsTemplates')}}">Cancel</a>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
