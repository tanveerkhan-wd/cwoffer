...
@section('title','Edit Seller Agent')
@section('script', url('public/js/dashboard/seller_agent.js'))
@section('content')	
<!-- Page Content  -->
<div class="section">
    <div class="container-fluid">
        <h2 class="title"><a data-slug="admin/sellerAgents" href="{{url('/admin/sellerAgents')}}"><span>{{'Seller Agent'}}</span></a>  >  {{'Edit'}}
        </h2>
        <div class="white_box">
            <div class="theme_tab">
                             ...
                             <div class="text-center">
                                  <div class="profile_box">
                                      <div class="profile_pic">
                                          <img id="img_tmp" src="@if(!empty($data['user_photo'])) {{url('public/uploads/'.Config::get('constant.images_dirs.USERS') )}}/{{$data['user_photo']}} @else {{ url('public/images/user.png') }}@endif">
