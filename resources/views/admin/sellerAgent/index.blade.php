	...
	<div class="container-fluid">
		<div class="row ">
            <div class="col-12 mb-3">
    			<h2 class="title">{{'Seller Agents'}}</h2>
            </div>
            ...
            <div class="col-md-2 text-md-right mb-3">
                <a data-slug="admin/addSellerAgent" href="{{url('/admin/addSellerAgent')}}"><button class="theme_btn show_modal full_width small_btn">{{'Add New'}}</button></a>
            </div>
        </div>
