function initialize() {
    ...
    for (let i = 0; i < locationInputs.length; i++) {
        ...
        const latitude = parseFloat(document.getElementById(fieldKey + "-latitude").value) || 37.9863967;
        const longitude = parseFloat(document.getElementById(fieldKey + "-longitude").value) || -83.9116557;
                ...
                for (var i = 0; i < place.address_components.length; i++) {
                  for (var j = 0; j < place.address_components[i].types.length; j++) {
                    if (place.address_components[i].types[j] == "postal_code") {
                      ...
                      $(".map-input").val(place.address_components[i].long_name);
                    }
                  }
                }
            });
