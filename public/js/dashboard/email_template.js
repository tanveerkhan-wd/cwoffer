...
var imagepath= base_url+'/public/images/';
  $('#email_template_listing').on( 'processing.dt', function ( e, settings, processing ) {
        ...
        "deferRender": true,
        "ajax": {
            "url": base_url+"/admin/emailSmsTemplates",
            "type": "POST",
            "dataType": 'json',
            "data": function ( d ) {
        ...
        columns:[
            ...
            { "data": "title", sortable:!1,
              render: function (data, type, row) {
                    return'<a href="'+base_url+'/admin/emailSmsTemplates/edit/'+row.email_sms_master_id+'"><img src="'+imagepath+'/ic_mode_edit.png"></a>'
              }
            },
      ],
  ...
  $("form[name='edit-form']").validate({
    errorClass: "error_msg",
     rules: {
      ...
      $.ajax({
          url: base_url+'/admin/emailSmsTemplates/edit',
          type: 'POST',
          processData: false,
          contentType: false,
          cache: false,              
          ...
          success: function(result)
          {
              ...
              if(result.status){
                $('a[data-slug="admin/emailSmsTemplates"]').trigger("click");
